...
class DB_workerTestCase(unittest.TestCase):
    ...
    def test_get_query_from_file(self):
        ...
        self.assertEqual(
            DB_worker.get_query_from_file("pg_queries/create_index.sql"),
    ...
    def test_get_query_from_file2(self):
        ...
        self.assertEqual(
            DB_worker.get_query_from_file("pg_queries/create_rooms.sql"),
    ...
    def test_get_query_from_file3(self):
        ...
        self.assertEqual(
            DB_worker.get_query_from_file("pg_queries/create_students.sql"),
